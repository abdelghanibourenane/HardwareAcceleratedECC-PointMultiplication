...
entity Radix2wECC_bf_mult_2_Pipeline_VITIS_LOOP_23_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of Radix2wECC_bf_mult_2_Pipeline_VITIS_LOOP_23_1 is 
...
attribute shreg_extract : string;
    ...
    signal i_reg_202 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal p_Result_32_fu_148_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal p_Result_32_reg_210 : STD_LOGIC_VECTOR (0 downto 0);
    signal p_Result_34_fu_179_p4 : STD_LOGIC_VECTOR (165 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal ap_loop_init : STD_LOGIC;
    signal i_30_fu_54 : STD_LOGIC_VECTOR (7 downto 0);
    signal i_31_fu_84_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln23_fu_78_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                p_Result_32_reg_210 <= p_Result_32_fu_148_p2;
            end if;
        end if;
    end process;
    ...
    and_ln_fu_130_p8 <= ((((((tmp_fu_100_p3 & ap_const_lv155_lc_1) & tmp_3_fu_108_p4) & ap_const_lv2_0) & tmp_5_fu_118_p3) & ap_const_lv2_0) & trunc_ln780_fu_126_p1);
    ...
    ap_sig_allocacmp_i_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, i_30_fu_54)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_i <= ap_const_lv8_0;
        else 
            ap_sig_allocacmp_i <= i_30_fu_54;
        end if; 
    end process;

    i_31_fu_84_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i) + unsigned(ap_const_lv8_1));
    icmp_ln23_fu_78_p2 <= "1" when (ap_sig_allocacmp_i = ap_const_lv8_A6) else "0";
    index_assign_cast_fu_163_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_reg_202),32));
    p_Result_32_fu_148_p2 <= "0" when (and_ln_fu_130_p8 = ap_const_lv164_lc_1) else "1";
    
    p_Result_34_fu_179_p4_proc : process(tmp_V_6_out_i, index_assign_cast_fu_163_p1, xor_ln24_fu_174_p2)
    begin
        p_Result_34_fu_179_p4 <= tmp_V_6_out_i;
        if to_integer(unsigned(index_assign_cast_fu_163_p1)) >= tmp_V_6_out_i'low and to_integer(unsigned(index_assign_cast_fu_163_p1)) <= tmp_V_6_out_i'high then
            p_Result_34_fu_179_p4(to_integer(unsigned(index_assign_cast_fu_163_p1))) <= xor_ln24_fu_174_p2(0);
        end if;
    end process;

    p_Result_s_fu_166_p3 <= tmp_V_6_out_i(to_integer(unsigned(index_assign_cast_fu_163_p1)) downto to_integer(unsigned(index_assign_cast_fu_163_p1))) when (to_integer(unsigned(index_assign_cast_fu_163_p1)) >= 0 and to_integer(unsigned(index_assign_cast_fu_163_p1)) <=165) else "-";
    ...
    tmp_3_fu_108_p4 <= shl_ln780_fu_94_p2(7 downto 6);
    tmp_5_fu_118_p3 <= shl_ln780_fu_94_p2(3 downto 3);

    tmp_V_6_out_o_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_V_5, tmp_V_6_out_i, p_Result_34_fu_179_p4, ap_block_pp0_stage0, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
            if ((ap_loop_init = ap_const_logic_1)) then 
                tmp_V_6_out_o <= tmp_V_5;
            elsif ((ap_enable_reg_pp0_iter1 = ap_const_logic_1)) then 
                tmp_V_6_out_o <= p_Result_34_fu_179_p4;
            else 
                tmp_V_6_out_o <= tmp_V_6_out_i;
            end if;
        else 
            tmp_V_6_out_o <= tmp_V_6_out_i;
        end if; 
    ...
    tmp_V_6_out_o_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001, ap_loop_init)
    begin
        if ((((ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)) or ((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
            tmp_V_6_out_o_ap_vld <= ap_const_logic_1;
        else 
            tmp_V_6_out_o_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    tmp_fu_100_p3 <= shl_ln780_fu_94_p2(163 downto 163);
    trunc_ln780_fu_126_p1 <= shl_ln780_fu_94_p2(1 - 1 downto 0);
    xor_ln24_fu_174_p2 <= (p_Result_s_fu_166_p3 xor p_Result_32_reg_210);
    zext_ln780_fu_90_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i),166));
end behav;
